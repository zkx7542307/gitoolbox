...
% see also AlergiaStochasticMerge AlergiaStochasticFold, AlergiaCompatible, AlergiaTest

function dffa = AlergiaPromote(qb, dffa)
%ALERGIAPROMOTE promotes a blue state
